  ...
  const contentByCategory = {
    ...
    poetry: {
      2026: [
        ...
        { text: '"Strange Configurations"', publication: 'Swamp Ape Magazine (print)', link: 'https://drive.google.com/file/d/1Tw7zCqOf1XWKPsgBCmTdVl_xVRlXwsdl/view?usp=sharing' },
        { text: '"No Consolation"', publication: 'Swamp Ape Magazine (print)', link: 'https://drive.google.com/file/d/1XyAARdrWj2CLL6sZc5i6wWscWsfagZdY/view?usp=sharing' },
        { text: '"WHAT YOU LOVE IS YOUR FATE"', publication: 'Indianapolis Review', link: 'https://theindianapolisreview.com/what-you-love-is-your-fate/'},
        { text: '"Love Poem With and Without"', publication: 'Indianapolis Review', link: 'https://theindianapolisreview.com/love-poem-with-and-without/'},
